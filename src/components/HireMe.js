  ...
  return (
    <div className='fixed left-4 bottom-4 flex items-center justify-center overflow-hidden md:right-8 md:left-auto md:top-0 md:bottom-auto md:absolute z-20'>
      <div className='w-48 h-auto flex items-center justify-center relative md:w-24'>
        ...
        {/* Central Button */}
        <Link 
          href="https://wa.me/919344515110?text=Hi%20Suriya%2C%20I%20came%20across%20your%20portfolio%20and%20would%20like%20to%20connect%20regarding%20an%20opportunity."
          target="_blank"
