    ...
    <header className='w-full px-32 py-8 font-medium flex items-center justify-between dark:text-light relative z-10 lg:px-16 md:px-12 sm:px-8'>
      ...
      <div className='w-full flex justify-between items-center lg:hidden'>
        ...
        <nav className='flex items-center justify-center flex-wrap gap-x-6'>
          ...
          {/* LinkedIn Icon */}
          <motion.a href="https://linkedin.com/in/suriyaprakash11" target="_blank" whileHover={{ y: -2 }} whileTap={{ scale: 0.9 }} className="w-6">
      ...
      {isOpen && (
        ...
        >
          ...
          <nav className='flex items-center justify-center flex-wrap gap-x-4 mt-8'>
            ...
            <motion.a href="https://linkedin.com/in/suriyaprakash11" target="_blank" whileHover={{ y: -2 }} whileTap={{ scale: 0.9 }} className="w-6 text-light dark:text-dark">
